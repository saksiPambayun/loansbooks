            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-medium">Buku yang Saya Pinjam</h3>
                                    ...
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                @if($loan->book->cover)
                                                    <img class="h-10 w-8 object-cover mr-3 rounded" src="{{ asset('storage/' . $loan->book->cover) }}" alt="">
                                                @else
                                                    <div class="h-10 w-8 bg-gray-200 mr-3 rounded flex items-center justify-center text-[8px] text-gray-400">No Cover</div>
                                                @endif
                                                <div>
